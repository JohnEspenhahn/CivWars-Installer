...
/*  79 */         return ((String)first.options().iterator().next()).compareTo((String)second.options().iterator().next());
/*     */       }
/*     */     };
/*  83 */     Set sorted = new TreeSet(comparator);
...
/*     */   {
/* 142 */     for (Iterator it = options.iterator(); it.hasNext(); ) {
/* 143 */       OptionDescriptor next = (OptionDescriptor)it.next();
...
/*     */ 
/* 182 */     for (Iterator i = descriptor.options().iterator(); i.hasNext(); ) {
/* 183 */       String option = (String)i.next();
...
/* 241 */     return (descriptor.description() + ' ' + Strings.surround(new StringBuilder().append("default: ").append(defaultValuesDisplay).toString(), '(', ')')).trim();
/*     */   }
/*     */ 
 ...
 * Qualified Name:     joptsimple.BuiltinHelpFormatter
