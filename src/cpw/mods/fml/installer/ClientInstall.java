...
public class ClientInstall implements ActionType {
    public boolean run(File target) {
        ...
        File civwarsFile = new File(new File(civwarsFolder, "mods"), VersionInfo.getCivWarsFile());
        try {
    ...
    public String getSuccessMessage() {
        return String.format("Successfully installed client profile %s for version %s into launcher", new Object[] {
                VersionInfo.getProfileName(),
